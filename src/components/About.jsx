const About = () => {
  ...
  return (
    <section
      id="about"
      className="relative w-full min-h-screen bg-gradient-to-br from-[#001529] via-[#003d5c] to-[#001529] py-16 px-4 sm:px-6"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-[#002140]/60 backdrop-blur-sm border border-[#005a8c]/50 rounded-xl p-6 text-center transition-all duration-200 hover:border-[#00B8D4]/50"
            >
              <div className="text-3xl sm:text-4xl font-bold text-[#00D4FF] mb-2">
                {stat.value}
              </div>
        ...
        {/* Mission Statement */}
        <div className="bg-gradient-to-r from-[#0077BE]/10 to-[#00B8D4]/10 border border-[#00B8D4]/20 rounded-2xl p-8 sm:p-10 mb-16">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((capability, index) => (
              <div
                key={index}
                className="bg-[#002140]/60 backdrop-blur-sm border border-[#005a8c]/50 rounded-xl p-6 transition-all duration-200 hover:border-[#00B8D4]/50 hover:shadow-lg hover:shadow-[#0077BE]/10"
              >
